...
**event** | Option<**Event**> |  (enum: post.scheduled, post.published, post.failed, post.partial, account.connected, account.disconnected, message.received, webhook.test) | [optional]
