...
**post_id** | Option<[**models::PostLogDetailAllOfPostId**](PostLogDetailAllOfPostId.md)> |  | [optional]
...
**account_id** | Option<[**models::PostLogDetailAllOfAccountId**](PostLogDetailAllOfAccountId.md)> |  | [optional]
...
**metadata** | Option<**serde_json::Value**> | Additional metadata (e.g., rate limit info) | [optional]
